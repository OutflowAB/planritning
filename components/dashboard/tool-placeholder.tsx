...
export function ToolPlaceholder({ children, className }: ToolPlaceholderProps) {
  return (
    <section
      className={`flex h-full min-h-[360px] w-full max-w-5xl items-center justify-center rounded-sm border border-white/35 bg-black/20 p-8 text-white backdrop-blur-sm ${className ?? ""}`}
    >
      {children ?? (
